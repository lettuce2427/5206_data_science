...
diamonds <- read.csv("diamonds_small.csv")
...
resampled_ests<-matrix(resampled_ests,nrow=1000,ncol=2)
...
# You'll want to type your response to question B(5) here.  Your response should look like:
 ...
 diff_estimates <-coefficients(lm0)[2]-resampled_values[,2]
