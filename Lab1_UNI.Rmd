...
# You'll want to type your response here.  Your response should look like:
 normal100 <- rnorm(100,mean = 0,sd=1)
mean(normal100)
sd(normal100)
...
```{r}
normal10<-rnorm(10,mean = 0,sd=1)
normal1000<-rnorm(1000,mean=0,sd=1)
normal10000<-rnorm(10000,mean = 0,sd=1)
normal100000<-rnorm(100000,mean = 0,sd=1)
```
...
```{r}
x<-colSums(normal1mil_mat)/nrow(normal1mil_mat)
```
